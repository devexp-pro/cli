...
import { manualDisconnectSshKeyAndUser } from "../old/commands/helpers.ts";
import {
  chooseUser,
  createNewUser,
  deleteUser,
} from "../old/commands/userManager.ts";
import {
  choseSshKey,
  createNewSshKey,
  deleteSshKey,
} from "../old/commands/sshKeyManager.ts";
import { connectUserToSsh } from "../old/commands/connectUserAndSshKey.ts";
import {
  activateProfile,
  showActiveProfileStatus,
} from "../old/commands/activateProfile.ts";
import { gitClone, gitCloneCommand } from "../old/commands/gitManager.ts";
import { about } from "../old/commands/about.ts";
import { fullReset } from "../old/commands/reset.ts";
