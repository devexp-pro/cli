...
import { IS_LOCAL_DEV } from "$/providers/version.ts";
        ...
        console.log(
          yellow(
            `New project added: ${newProject.name}${
              IS_LOCAL_DEV ? ` (UUID: ${newProject.uuid})` : ""
            }`,
          ),
        );
                ...
                console.log(
                  yellow(
                    `New secret added: ${newSecret.key}${
                      IS_LOCAL_DEV ? ` (UUID: ${newSecret.uuid})` : ""
                ...
                console.log(
                  yellow(
                    `Secret removed: ${currentSecret.key}${
                      IS_LOCAL_DEV ? ` (UUID: ${currentSecret.uuid})` : ""
            ...
            console.log(
              yellow(
                `Environment removed: ${currentEnv.name}${
                  IS_LOCAL_DEV ? ` (UUID: ${currentEnv.uuid})` : ""
        ...
        console.log(
          yellow(
            `Project removed: ${currentProject.name}${
              IS_LOCAL_DEV ? ` (UUID: ${currentProject.uuid})` : ""
            }`,
          ),
        );
        changesDetected = true;
